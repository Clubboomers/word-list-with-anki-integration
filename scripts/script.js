...
function error_handle_function() {
  window.alert(
    `Failed to connect to Anki. Make sure Anki is running in the background and has AnkiConnect installed. Ensure that "${URL}" is in the webCorsOriginList in your AnkiConnects configuration`
  );
}
